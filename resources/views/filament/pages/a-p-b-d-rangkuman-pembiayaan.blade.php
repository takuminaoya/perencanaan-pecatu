<x-filament-panels::page>
    ...
    <div class="selector-bar__inner">
        ...
        <a href="{{ route('print.apbd', ['id' => $apbd->id, 'mode' => 'pembiayaan']) }}" target="_BLANK" class="selector-bar__action">Print</a>
    </div>
            ...
            <div class="masthead__inner">
                <div>
                    ...
                    <h1 class="masthead__title">
                        Rincian Anggaran <em>Pembiayaan</em> Desa
                    </h1>
        ...
        <main class="page">
            <section class="panel">
                ...
                <div class="section-head">
                    <div>
                        <h2>Rincian Anggaran Pembiayaan</h2>
                        <p>

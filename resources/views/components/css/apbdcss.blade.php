<style>
    ...
    .eyebrow .rule {
        width: 28px;
        height: 1px;
        background: rgba(224, 189, 121, 0.5);
    }
    ...
    table.apbdes tbody tr:hover td {
        background: rgba(20, 83, 106, 0.04);
    }
    ...
    .btn-toggle:hover {
        background: rgba(224, 189, 121, 0.15);
    }
    ...
    .bidang-card.collapsed .btn-toggle .toggle-label::after {
        content: "Tampilkan";
    }
    ...
    table.rincian th.num,
    table.rincian td.num {
        text-align: right;
        font-family: var(--font-mono);
    }
    ...
    table.rincian tbody tr:last-child td {
        border-bottom: none;
    }

    table.rincian tbody tr:hover td {
        background: rgba(20, 83, 106, 0.035);
    }

    table.rincian td.kode {
        color: var(--text-soft);
        font-family: var(--font-mono);
        font-size: 11.5px;
        width: 64px;
    ...
    .fab-item.fab-docs .fab-item-icon {
        color: var(--emblem-blue);
    }

    .fab-item.fab-add .fab-item-icon {
        color: var(--success);
    }
    ...
    .kegiatan-info-row:first-child .kegiatan-info-toggle {
        border-top: none;
        margin-top: 0;
    }

    .kegiatan-info-toggle:hover {
        background: rgba(20, 83, 106, 0.035);
    }

    .kegiatan-info-toggle:focus-visible {
        outline: 2px solid var(--info);
        outline-offset: -2px;
    }

    /* tampilan lengkap (terbuka): tabel Bidang/Sub Bidang/Kegiatan/Waktu/Output */
    .kegiatan-table {
        flex: 1;
        width: 100%;
        border-collapse: collapse;
    ...
    .kegiatan-table td.ki-label {
        width: 190px;
        white-space: nowrap;
    }

    .kegiatan-table td.ki-colon {
        width: 18px;
        padding-left: 0;
        padding-right: 0;
    }

    /* tampilan ringkas (tertutup): hanya nama kegiatan */
    .kegiatan-summary {
        display: none;
        flex: 1;
        align-items: center;
    ...
    .kegiatan-summary .ki-label {
        white-space: nowrap;
    }

    .kegiatan-summary .ki-colon {
        width: 6px;
    }

    .kegiatan-summary .ki-value {
        color: var(--digital-blue);
    }

    .kegiatan-info-toggle[aria-expanded="true"] .kegiatan-summary {
        display: none;
    }

    .kegiatan-info-toggle[aria-expanded="true"] .kegiatan-table {
        display: table;
    }

    .kegiatan-info-toggle[aria-expanded="false"] .kegiatan-summary {
        display: flex;
    }

    .kegiatan-info-toggle[aria-expanded="false"] .kegiatan-table {
        display: none;
    }
    ...
    .kegiatan-chevron svg {
        width: 18px;
        height: 18px;
        transition: transform 0.25s ease;
    }

    .kegiatan-info-toggle[aria-expanded="false"] .kegiatan-chevron svg {

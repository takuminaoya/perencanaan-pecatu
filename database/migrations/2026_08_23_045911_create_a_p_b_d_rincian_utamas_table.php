...
return new class extends Migration
{
    ...
    {
        Schema::create('ep_apbd_rincian_utamas', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignIdFor(APBDDetailSubMain::class, 'apbdsm_id')->constrained()->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('ep_apbd_rincian_utamas');
    }
};
